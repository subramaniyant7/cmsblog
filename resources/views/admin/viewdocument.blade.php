                                    ...
                                    <tbody>
                                        @forelse ($documents as $k => $category)
                                            <tr>
                                                ...
                                                <td>{{ $category->document_name }}</td>
                                                <td>{{ statustype()[$category->status - 1] }}</td>
                                                <td>
                                                    <a
                                                        href="{{ url(ADMINURL . '/actiondocument/edit/' . encryption($category->document_id)) }}">
                                                        <i class="nav-icon fas fa-pencil-alt" style="margin-right:1em"></i>
                                                    </a>
                                                    <a
                                                        href="{{ url(ADMINURL . '/actiondocument/delete/' . encryption($category->document_id)) }}">
