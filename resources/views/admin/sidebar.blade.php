        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ $innovation }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ ADMINURL . '/actionpagetypeinfo?type=' . encryption(pageName()['survivo']) . '&&page=' . encryption(pageName()['innov']) }}" class="nav-link {{ request()->type && decryption(request()->type) == pageName()['survivo'] ? 'active' : '' }}">
                                <i class="fas fa-book nav-icon"></i>
                                <p>Survivo Wellness</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ ADMINURL . '/actionpagetypeinfo?type=' . encryption(pageName()['goggle']) . '&&page=' . encryption(pageName()['innov']) }}" class="nav-link {{ request()->type && decryption(request()->type) == pageName()['goggle'] ? 'active' : '' }}">
                                <i class="fas fa-book nav-icon"></i>
                                <p>Goggle Tech</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ $software }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ ADMINURL . '/actionpagetypeinfo?type=' . encryption(pageName()['life']) . '&&page=' . encryption(pageName()['soft']) }}" class="nav-link {{ request()->type && decryption(request()->type) == pageName()['life'] ? 'active' : '' }}">
                                <i class="fas fa-book nav-icon"></i>
                                <p>Life Whisperer</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ ADMINURL . '/actionpagetypeinfo?type=' . encryption(pageName()['ferti']) . '&&page=' . encryption(pageName()['soft']) }}" class="nav-link {{ request()->type && decryption(request()->type) == pageName()['ferti'] ? 'active' : '' }}">
                                <i class="fas fa-book nav-icon"></i>
                                <p>Ferti Assist</p>
                            </a>
                        </li>
